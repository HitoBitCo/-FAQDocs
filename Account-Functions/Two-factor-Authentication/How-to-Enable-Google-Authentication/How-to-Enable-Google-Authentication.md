...
![امنیت حساب](account-security.png)

**3.**	روی دکمه **[فعال‌کردن]** در مقابل  **[احراز هویت گوگل]** کلیک کنید.
![فعال‌کردن احراز هویت گوگل](activate-2FA.png)
...
![کد پشتیبان](save-backup-code.png)
...
![کد احراز هویت گوگل](google-authentication.png)
...
![اتمام فعال‌سازی احراز هویت](finished-google-authentication.png)
